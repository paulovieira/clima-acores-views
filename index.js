...
internals.config.redirectToCartografia = {
    handler: function(request, reply){

        var lang = request.params.lang || Config.get("allowedLanguages")[0];
        console.log(request.params.lang);

        return reply.redirect("/" + lang + "/cartografia");
    },
    validate: {
        params: Validate.lang
    },
...
internals.endpoints = [
...

    {
        ...
        config: {
            handler: function(request, reply) {
                return reply.redirect("/" + Config.get("allowedLanguages")[0] + "/cartografia");
            },
            auth: false,
        }
    },
...

    {
        ...
        config: internals.config.redirectToCartografia
    },
